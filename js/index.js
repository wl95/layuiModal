function modalDom () {
	return `
	<div class="chat_modal_wrap" style="width:815px; height: 550px;">
...
<div class="chat_model_right" style="height:550px; width: 780px;">
    <div class="chat_model_table">
      <form class="layui-form model_table_form" action="">
        <div class="layui-form-item">
          <div class="layui-inline">
            <img src="./img/zu.png" alt="" style="width: 28px;">
          </div>
          <div class="layui-inline" id="cascader">
            <input type="text" name="addres" required="" lay-verify="required" placeholder="请选择装货地址" autocomplete="off"
              class="layui-input" style="width: 170px;">
          </div>
          <div class="layui-inline">
          ...
          <div class="layui-inline">
            <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" style="height: 38px; width: 38px;">
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            <img src="./img/red.png" alt="" style="width: 28px;margin: 0;">
          </div>
          <div class="layui-inline" id="cascader1">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-inline">
            <input type="text" name="ew" required="" lay-verify="required" placeholder="请输入标题" autocomplete="off"
              class="layui-input" style="width: 555px;">
          </div>
        </div>
        <div class="layui-form-item">
          <div class=" layui-inline all">
            <div class="tag tag1 layui-inline">历史</div>
            <div class="tag tag1 layui-inline">司机报价</div>
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-inline">
            <input type="text" name="title" required="" lay-verify="required" placeholder="请输入标题" autocomplete="off"
              class="layui-input" style="width: 226px;">
          </div>
          <div class="layui-inline">
            <input type="text" name="title" required="" lay-verify="required" placeholder="请输入标题" autocomplete="off"
          ...
          <div class="layui-inline">
            <button class="layui-btn layui-btn-normal" lay-submit lay-filter="formDemo" style="width:90px" id="supply_save">保存</button>
          </div>
          <div class="layui-inline">
            <button type="reset"  class="layui-btn layui-btn-primary layui-border-blue" style="width:90px">清空</button>
          </div>

        </div>
      </form>
      <table id="chat-table" lay-filter="test"></table>
 		</div>
  </div>`
}
